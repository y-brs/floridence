      ...
      <header className={scrolled ? 'header hide' : 'header show'} ref={ref}>
        <div className='header__container'>
          <div className='header__top'>
            {scrolled ? (
              <img src={ImageLogoMobile} className='header__top-logoMobile' alt='' srcSet='' onClick={() => window.scrollTo(0, 0)} />
            ) : (
              <HashLink to='/'>
                <img src={ImageLogo} alt='' className='header__top-logo' />
              </HashLink>
            )}
            ...
            <button className='header__burger' onClick={() => dispatch(openMenu())}>
