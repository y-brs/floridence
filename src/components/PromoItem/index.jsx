...
function PromoItem({ name, price, defaultPicture, offers }) {
  ...
  const productOfferValue = Object.values(offers)[0]?.PRICES;
      ...
      <div className={Style.promo_item_container}>
        ...
        <div className={Style.promo_item_desc}>
          ...
          <span className={Style.promo_item_price}>
            {new Intl.NumberFormat('ru-RU', { maximumSignificantDigits: 3 }).format(productPriceValue ? productPriceValue : Object.values(productOfferValue)[0]?.PRICE)}&nbsp;₽
          </span>
        </div>
      </div>
    </div>
