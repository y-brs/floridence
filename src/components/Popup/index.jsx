  ...
  return (
    <div className={isShow ? Style.popup : Style.popup_close}>
      <div className={Style.text}>
        {!isDelete ? (
          <>
            <svg className={Style.icon} viewBox='64 64 896 896' width='1.2rem' height='1.2rem' fill='currentColor' aria-hidden='true'>
          ...
          <>
            <div>
              <svg className={Style.icon_close} fill-rule='evenodd' viewBox='64 64 896 896' width='1.2rem' height='1.2rem' fill='currentColor' aria-hidden='true'>
